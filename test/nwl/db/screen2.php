...
This program displays employee city drop down from database.
 -->
<html>
<head>
...
function myFunction()
{
 var elSel = document.getElementById('element');
  ...
  $("#loadHere1").load("../db/getLastNames.php",{value:value});
}
</script>
</head>
<body>
...
$result = mysqli_query($con,"select * from classicmodels.Offices");
