    ...
    <thead >
			<tr>
				<td colspan="4"><label for="searchbox">Search:</label> <input
					...
					<input type="checkbox" id="teamsID" value="Teams">Teams
					<input type="checkbox" id="playersID" value="Players">Players
					<input type="checkbox" id="coachID" value="Coach">Coach
					<input type="checkbox" id="refereeID" value="Referee">Referee
				</td></tr>
		</thead>
</table>
